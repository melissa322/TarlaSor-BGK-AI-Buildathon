...
- İki farklı kullanıcı tipi:
  - **Belirti ile gelen:** Sararan yaprak, kuruyan bitki, verimsiz toprak gibi gözlemlerini anlatır veya fotoğraf çeker
...
Uygulama iki ana analiz alanını kapsar:

1. **Toprak Analizi** — Fotoğraf, belirti anlatımı veya lab değerleriyle toprağın durumu
...
### Ekran 1 — Ana Sayfa
- TarlaSor logosu ve kısa tanıtım cümlesi
- İki büyük seçenek kartı:
  - 🌱 **Toprağımı Analiz Et**
  - 💧 **Sulama Suyumu Analiz Et**
- Alt kısımda "Nasıl Çalışır?" kısa açıklaması (3 adım: Gir → Analiz Et → Öğren)

### Ekran 2 — Giriş Ekranı (Toprak veya Su için ayrı ayrı)
Kullanıcı üç yöntemden birini veya birden fazlasını seçebilir:

**Yöntem A — Fotoğraf Yükle**
- Galeriden seç veya kameradan çek
- "Bu fotoğrafta ne görüyorsunuz?" kısa açıklama alanı

**Yöntem B — Belirti Anlat**
...
- **Giriş:** Fotoğraf (base64), serbest metin, lab değerleri veya kombinasyonu
- **Sistem mesajı:** "Sen Türkiye'deki çiftçilere yardımcı olan bir toprak ve su kalitesi uzmanısın. Teknik terim kullanmadan, sade Türkçeyle yanıt ver. Her zaman somut ve uygulanabilir öneriler sun."
...
- **AI:** Claude API
- **Deploy:** Lovable veya Netlify
- **Fotoğraf:** Base64 ile API'ye gönderim
- **Mobil uyum:** Zorunlu
